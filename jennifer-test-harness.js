...
const scenarios = [
  ...
  },
  {
    ...
    messages: [
      "hey im Chris, 405-555-7777, OGE customer paying 300 a month, want a quote. afternoons are best",
    ],
    expect: { shouldCaptureLead: true },
  },
  {
  ...
  {
    name: "BOT_SUSPICION",
    description: "Visitor suspects bot and needs honest redirect",
    messages: [
      "are you just a bot",
      "ok, my bill is 260 with OGE and i want to see if this is worth it",
      "name is Morgan Lee",
      "405-555-0101",
      "afternoons",
    ],
  ...
  {
    name: "PARTIAL_PHONE_LEAD",
    description: "Visitor gives phone but leaves before preferred time",
    messages: [
      "i already got two quotes and want another opinion",
      "OGE, around 240 a month",
      "call me at 405-555-0202",
    ],
    expect: { shouldCaptureLead: true },
  },
];
